      ...
      <div className="container mx-auto px-4 relative z-10 pt-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 rounded-full px-4 py-2 mb-8 animate-fade-in">
            ...
            <span className="text-primary text-sm font-medium">Digital Marketing Specialist</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 animate-slide-up" style={{ animationDelay: "0.2s" }}>
            Hi, I'm <span className="text-secondary-foreground font-semibold">Pratyaksh Dixit</span> – a results-driven digital marketing professional with expertise in SEO, content marketing, Meta Ads, Google Ads, and LinkedIn advertising.
          </p>
